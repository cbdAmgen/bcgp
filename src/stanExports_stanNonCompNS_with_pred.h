...
namespace model_stanNonCompNS_with_pred_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_stanNonCompNS_with_pred");
    ...
    reader.add_event(369, 3, "restart", "model_stanNonCompNS_with_pred");
    reader.add_event(458, 90, "end", "model_stanNonCompNS_with_pred");
    return reader;
}
...
class model_stanNonCompNS_with_pred : public prob_grad {
private:
        int n;
        int d;
        vector_d y;
        ...
        matrix_d x_pred;
public:
    model_stanNonCompNS_with_pred(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_stanNonCompNS_with_pred_namespace::model_stanNonCompNS_with_pred";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_stanNonCompNS_with_pred_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::initialize(y_pred, DUMMY_VAR__);
            stan::math::fill(y_pred, DUMMY_VAR__);
            stan::math::assign(y_pred,gp_pred_noncomp_ns_rng(x, y, x_pred, beta0, rho, sigma2eps, V, V_pred, base_rng__, pstream__));
    ...
    static std::string model_name() {
        return "model_stanNonCompNS_with_pred";
    }
...
typedef model_stanNonCompNS_with_pred_namespace::model_stanNonCompNS_with_pred stan_model;
#endif
