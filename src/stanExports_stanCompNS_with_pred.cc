...
#include "stanExports_stanCompNS_with_pred.h"

RCPP_MODULE(stan_fit4stanCompNS_with_pred_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_stanCompNS_with_pred")
