...
namespace model_stanCompS_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_stanCompS");
    ...
    reader.add_event(119, 3, "restart", "model_stanCompS");
    reader.add_event(187, 69, "end", "model_stanCompS");
    return reader;
}
...
class model_stanCompS : public prob_grad {
private:
        int n;
        int d;
        vector_d y;
...
public:
    model_stanCompS(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_stanCompS_namespace::model_stanCompS";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_stanCompS_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_stanCompS_namespace::model_stanCompS stan_model;
#endif
