...
namespace model_stanNonCompNS_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_stanNonCompNS");
    ...
    reader.add_event(369, 3, "restart", "model_stanNonCompNS");
    reader.add_event(446, 78, "end", "model_stanNonCompNS");
    return reader;
}
...
class model_stanNonCompNS : public prob_grad {
private:
        int n;
        int d;
        vector_d y;
...
public:
    model_stanNonCompNS(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_stanNonCompNS_namespace::model_stanNonCompNS";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_stanNonCompNS_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_stanNonCompNS_namespace::model_stanNonCompNS stan_model;
#endif
